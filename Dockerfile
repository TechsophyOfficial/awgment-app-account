...
ENTRYPOINT ["java", "-Dotel.exporter=jaeger", "-Dotel.exporter.jaeger.endpoint=http://jaeger:14250", "-Dotel.exporter.jaeger.service.name=tp-app-account", "-Dapplication.name=tp-app-account", "-jar","/home/spring/app/bin/tp-app-account-1.2.0.jar"]
